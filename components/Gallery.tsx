...
const localImages = [
  { src: "components/public/img/gallery1.webp", position: "object-top" },
  { src: "components/public/img/gallery2.webp", position: "object-left pr-9 mr-15 mt-10 " }, // Fokus tengah default
  { src: "components/public/img/gallery3.webp", position: "object-center pl-3 " }, // Potong bagian atas
  { src: "components/public/img/gallery41.webp", position: "object-center pr-8" },
  { src: "components/public/img/gallery5.webp", position: "object-[50%_20%]" }, // Posisi kustom 20% dari atas
  { src: "components/public/img/gallery6.webp", position: "object-center pl-8" },
];
;
